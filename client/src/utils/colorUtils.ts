// c:\Users\eber\Documents\coloristia\client\src\utils\colorUtils.ts
...
// Genera variaciones Monocromáticas usando HSL
export function getMonochromaticVariations(h: number, s: number, _l: number, count: number): [number, number, number][] {
  return generateHueFamily(h, s, count);
}

// Genera variaciones Analógicas usando HSL
...
// Genera escalas complementarias
export function getComplementaryVariations(h: number, s: number, _l: number, count: number): [number, number, number][] {
...
// Genera escalas Triádicas
export function getTriadicVariations(h: number, s: number, _l: number, count: number): [number, number, number][] {
...
export function getSplitComplementaryVariations(h: number, s: number, _l: number, count: number): [number, number, number][] {
  const perFamilyBase = Math.floor(count / 3) + (count % 3 > 0 ? 1 : 0);
